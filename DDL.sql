...
-- Table `sakila`.`rides`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`rides` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `waiting_time` VARCHAR(45) NOT NULL,
...
-- Table `sakila`.`lines`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`lines` (
  `users_id` INT NOT NULL,
  `rides_id` INT NOT NULL,
  PRIMARY KEY (`users_id`, `rides_id`),
  INDEX `fk_users_has_rides_rides1_idx` (`rides_id` ASC),
  INDEX `fk_users_has_rides_users1_idx` (`users_id` ASC),
